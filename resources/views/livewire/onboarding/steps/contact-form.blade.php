...
<div class="row g-3">
    ...
    <div class="col-12 d-flex justify-content-end">
        <button class="btn btn-primary text-light waves-effect waves-light w-100" wire:click="save"
            wire:loading.attr="disabled" wire:target="save">
            <span wire:loading.remove wire:target="save">Proceed <i
                    class="mdi mdi-arrow-right align-middle ms-1"></i></span>
